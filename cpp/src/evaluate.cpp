        ...
        for (int pt = 0; pt < 6; ++pt) {
            ...
            while (b) {
                ...
                if (pt == PAWN) {
                    ...
                    if ((rank == 3 || rank == 4) && (file == 3 || file == 4)) score += 0.50 * sign;
                    else if ((rank == 2 || rank == 5) && (file == 2 || file == 5)) score += 0.25 * sign;
                    else if (rank == 0 || rank == 7 || file == 0 || file == 7) score -= 0.50 * sign;
                } else if (pt == KING) {
                    if (color == WHITE && rank == 0 && (file == 2 || file == 6)) score += 0.75;
                    else if (color == BLACK && rank == 7 && (file == 2 || file == 6)) score -= 0.75;
                }
            }
        }
    }
